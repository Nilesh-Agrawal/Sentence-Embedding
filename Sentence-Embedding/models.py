...
class BLSTMEncoder(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.bsize = config['bsize'] #64
        self.word_emb_dim = config['word_emb_dim'] #300
        self.enc_lstm_dim = config['enc_lstm_dim'] #2048
        self.pool_type = config['pool_type'] #max
        self.dpout_model = config['dpout_model'] #0
...
class NLINet(nn.Module):
    def __init__(self, config):
        ...
        # classifier
        self.nonlinear_fc = config['nonlinear_fc'] #0
        self.fc_dim = config['fc_dim'] #512
        self.n_classes = 3
        self.enc_lstm_dim = config['enc_lstm_dim'] #2048
        self.encoder_type = config['encoder_type'] #BLSTMEncoder
        self.dpout_fc = config['dpout_fc'] #0
...
"""
Main module for Classification (Not Used)
"""
